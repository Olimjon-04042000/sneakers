      ...
      <div className="flex items-center justify-between ">
        <div className="flex gap-[56.5px] items-center">
          ...
          <ul className="flex gap-8 text-[#69707D] text-[15px] ">
            <li className="cursor-pointer  text-[#69707D] text-[15px] hover:text-[#1D2026] relative before:absolute before:content-[''] before:w-[77px] before:h-1 before:bg- hover:before:bg-[#FF7E1B] before:top-16 ">Collections</li>
            <li className="cursor-pointer hover:text-[#1D2026] relative before:absolute before:content-[''] before:w-[30px] before:h-1  hover:before:bg-[#FF7E1B] before:top-16 before:left-[0.8px] ">Men</li>
            <li className="cursor-pointer hover:text-[#1D2026] relative before:absolute before:content-[''] before:w-[53.5px] before:h-1 before:bg- hover:before:bg-[#FF7E1B] before:top-16 before:left-[0.8px]">Women</li>
            <li className="cursor-pointer hover:text-[#1D2026] relative before:absolute before:content-[''] before:w-[44px] before:h-1 before:bg- hover:before:bg-[#FF7E1B] before:top-16 ">About</li>
            <li className="cursor-pointer hover:text-[#1D2026] relative before:absolute before:content-[''] before:w-[55px] before:h-1 before:bg- hover:before:bg-[#FF7E1B] before:top-16 ">Contact</li>
          </ul>
        </div>
            ...
            >
              ...
              <div className=" h-[188px] p-6 pb-8">
                <div className=" flex items-center justify-between mb-[26px]">
                  ...
                  />
                  <div>
                    <p className=" leading-[26px] text-[#69707D] text-[16px]">Fall Limited Edition Sneakers</p>
                    <p className="leading-[26px] text-[#69707D] text-[16px] flex gap-[6px]">
                      $125.00 x 3<span className="text-[#1D2026] text-[16px] font-bold leading-[26px]">$375.00</span>
                    </p>
                  </div>
                  <img className="cursor-pointer " src="/del-btn.svg" alt="delete" />
                </div>
                <button className=" w-[100%] bg-[#FF7E1B] rounded-[10px] text-white pt-[22px] pb-[18px] font-bold">Checkout</button>
              </div>
            </div>
          </div>
          <img className="border-[3px] rounded-[50px] border-white hover:border-[#FF7E1B]" src="/Oval.svg" alt="user" />
        </div>
      </div>
    </div>
  );
