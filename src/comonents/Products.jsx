  ...
  return (
    <div className="mt-[90px] px-12 flex justify-between ">
      <div className="mb-[132px]">
        <div
          className="btn  h-[445px] border-none min-h-[445px]  rounded shadow-none bg-white hover:bg-white hover:border-none"
      ...
      <div className="mt-[62px] w-[44%] ">
        ...
        <div className="flex gap-4">
          <div className="flex items-center justify-between px-4 rounded-[10px] h-14 w-[157px] bg-[#F6F8FD]">
            ...
            <p className="text-[#1D2026] font-bold text-[16px]">0</p>
            <button className="border-none">
              <img src="/plus.svg" alt="plus-icon" />
            </button>
          </div>
          <button className="bg-[#FF7E1B] hover:bg-[#FFAB6A] text-white flex items-center gap-[15.54px] rounded-[10px] px-[76px] py-4 font-bold text-[16px]">
